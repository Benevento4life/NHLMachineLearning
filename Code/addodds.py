...
df_odds = pd.read_csv("scrapedOdds.csv") # Byt ut filnamnet om du så önskar
df_large = pd.read_csv("cutData.csv") # Byt ut filnamnet om du så önskar
...
df_large.to_csv("cutDataWithOdds.csv", index=False) # Byt ut filnamnet om du så önskar
