...
Programmet bygger som nu skrivit en Extra Trees-modell. Detta kan även ändras genom att modifiera rad 50.
'''
...
dataset = pd.read_csv('exampleProcessedData.csv') # Byt ut filnamnet om du så önskar
...
model = create_model('et') # Byt ut argumentet för annan modell
...
unseen_predictions.to_csv('examplePredictions.csv') # Byt filnamn om du så önskar

# Sparar modellen som en .pkl-fil

save_model(model, 'exampleModel') # Byt ut filnamnet om du så önskar
