...
df = pd.read_csv('exampleDataWithOdds.csv') # Byt ut filnamnet om du så önskar
...
copy.to_csv('exampleProcessedData.csv', index=False) # Byt ut filnamnet om du så önskar
